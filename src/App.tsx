...
const ROOMS = ['Main', 'Conference Room A', 'Conference Room B', 'Pod A', 'Pod B'];
const TIMES = [
                    ...
                    {ROOMS.map(room => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-full text-left px-4 py-3 border-b border-black last:border-b-0 font-medium flex justify-between items-center ${
                            selectedRoom === room ? 'bg-gray-100' : 'hover:bg-gray-50'
                          }`}
                        >
            ...
            {ROOMS.map(room => {
              ...
              return (
                <button
                  ...
                  className={`whitespace-nowrap px-4 py-3 border-b border-black text-left font-medium transition-colors min-h-[44px] flex justify-between items-center ${
                    selectedRoom === room ? 'bg-black text-white' : 'bg-white text-black hover:bg-black hover:text-white'
                  }`}
                >
                  <span>{room}</span>
                  {avail > 0 ? (
